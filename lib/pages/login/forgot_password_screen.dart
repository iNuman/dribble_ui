...
import 'package:dribble_ui/pages/login/change_password_screen.dart';
              ...
              children: [
                Row(
                  children: [
                    ...
                    getCustomText(
                        "Forgot Password", fontBlack, 1, TextAlign.center, FontWeight.w800, getLoginTitleFontSize()),
                    Expanded(
                      flex: 1,
                      child: Container(),
                    ),
                ...
                getCustomTextWithoutMaxLine("Please enter email for forgot your\npassword.", fontBlack,

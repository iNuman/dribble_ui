              ...
              children: [
                Row(
                  children: [
                    ...
                    getCustomText(
                        "Change Password", fontBlack, 1, TextAlign.center, FontWeight.w800, getLoginTitleFontSize()),
                    Expanded(
                      flex: 1,
                      child: Container(),
                    ),
                ...
                getCustomTextWithoutMaxLine("Please enter new password for\nchange your password.", fontBlack,
                    TextAlign.center, FontWeight.w400, getEdtTextSize()),
                getSpace(appBarPadding),
                ValueListenableBuilder(
                  builder: (context, value, child) {
                    return getPassTextField(emailSignInController, "Password", "Lock.svg", isShowPass.value, () {
                ...
                ValueListenableBuilder(
                  builder: (context, value, child) {
                    return getPassTextField(passSignInController, "Confirm Password", "Lock.svg", confirmShowPass.value,
                        () {
                ...
                }, FontWeight.w600, EdgeInsets.symmetric(vertical: appBarPadding))
              ],
            ),
          )),
        ),

...
class _LoginScreen extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  Future getResponse() async {
    var res = await rootBundle.loadString('assets/countries.json');
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle style =
        TextStyle(color: fontBlack, fontSize: fontSize, fontFamily: Constant.fontsFamily, fontWeight: FontWeight.w500);
            ...
            children: [
              TabBar(
                ...
                tabs: [
                  Tab(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        decoration: (_selectedTabbar == 0) ? TextDecoration.underline : TextDecoration.none,
                  ...
                  Tab(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        decoration: (_selectedTabbar == 1) ? TextDecoration.underline : TextDecoration.none,
                        decorationColor: primaryColor.withOpacity(0.4),
                        decorationThickness: 6,
                        decorationStyle: TextDecorationStyle.solid,
                      ),
                ...
                labelStyle: TextStyle(
                    color: fontBlack, fontWeight: FontWeight.bold, fontSize: Constant.getPercentSize(screenHeight, 3)),
                        ...
                        children: [
                          ...
                          Align(
                              ...
                              child: InkWell(
                                ...
                                child: getCustomText("Forgot Password?", fontBlack, 1, TextAlign.end, FontWeight.bold,
                          ...
                          getCustomText("Or sign in with", Colors.grey, 1, TextAlign.center, FontWeight.w400,
                              Constant.getPercentSize(screenHeight, 1.7)),
                          Row(
                            children: [
                              Expanded(
                                child: getButtonContainer(
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        getCustomText(
                                            "Google", fontBlack, 1, TextAlign.center, FontWeight.bold, getEdtTextSize())
                                      ],
                                    ),
                                    EdgeInsets.only(
                                        left: 0, top: appbarPadding, bottom: appbarPadding, right: appbarPadding / 2),
                                    backgroundColor),
                                flex: 1,
                              ),
                              Expanded(
                                child: getButtonContainer(
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        getHorSpace(Constant.getPercentSize(screenWidth, 1.7)),
                                        getCustomText("Facebook", fontBlack, 1, TextAlign.center, FontWeight.bold,
                                            getEdtTextSize())
                                      ],
                                    ),
                                    EdgeInsets.only(
                                        left: appbarPadding / 2, top: appbarPadding, bottom: appbarPadding, right: 0),
                                    backgroundColor),
                                flex: 1,
                              ),
                            ],
                  ...
                  : Container(
                      ...
                      child: Column(
                        children: [
                          getSpace(Constant.getPercentSize(screenHeight, 3)),
                          getLoginTextField(emailSignInController, "Email", "email.svg"),
                          getLoginTextField(emailRegPhoneController, "Phone Number", "Call_Calling.svg"),
                          Padding(
                            padding: EdgeInsets.symmetric(vertical: Constant.getHeightPercentSize(1.2)),
                            child: SizedBox(
                              height: height,
                              child: Container(
                          ...
                          Row(
                            children: [
                              ...
                              getCustomText("I accepted", fontBlack, 1, TextAlign.start, FontWeight.w400, privacySize),
                              getHorSpace(Constant.getPercentSize(screenWidth, 1.5)),
                              Expanded(
                                flex: 1,
                                child: getCustomText("Terms & Privacy Policy", primaryColor, 1, TextAlign.start,

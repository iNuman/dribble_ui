              ...
              children: [
                Row(
                  children: [
                    ...
                    getCustomText(
                        "Verify Code", fontBlack, 1, TextAlign.center, FontWeight.w800, getLoginTitleFontSize()),
                    Expanded(
                      flex: 1,
                      child: Container(),
                    ),
                ...
                getCustomTextWithoutMaxLine("Please enter verify code that we've \nsent to your email.", fontBlack,
                ...
                PinCodeFields(
                  ...
                  margin: EdgeInsets.all(Constant.getPercentSize(appBarPadding, 70)),
                  borderWidth: 0.5,
                  borderColor: greyFont,
                  borderRadius: BorderRadius.all(Radius.circular(Constant.getPercentSize(screenWidth, 3))),
